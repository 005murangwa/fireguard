  ...
  return (
    <AuthProvider>
      ...
      <Routes>
        ...
        <Route path="/orders" element={<ProtectedRoute><Layout><RoleRoute roles={['ADMIN', 'CLIENT']}><OrdersPage /></RoleRoute></Layout></ProtectedRoute>} />
        <Route path="/staff" element={<ProtectedRoute><Layout><RoleRoute roles={['CLIENT']}><StaffPage /></RoleRoute></Layout></ProtectedRoute>} />
